...
class FacilityTypeDAOIntegrationTest {
	...
	private static final FacilityTypeDB FACILITY_TYPE = new FacilityTypeDB("Factory","BeerGameZutphen",50,50,50,50,50,50);
	private static final FacilityTypeDB FACILITY_TYPE2 = new FacilityTypeDB("Wholesale","BeerGameZutphen",50,50,50,50,50,50);
	private static final FacilityTypeDB FACILITY_TYPE2_UPDATE = new FacilityTypeDB("Wholesale","BeerGameZutphen",999,999,999,999,999,999);
	...
	void createFacilityType() {
		...
		FacilityTypeDB facilityTypeDb = facilityTypeDAO.readSpecificFacilityType("BeerGameZutphen","Factory");
	...
	void updateFacilityType() {
		...
		FacilityTypeDB facilityTypeDb = facilityTypeDAO.readSpecificFacilityType("BeerGameZutphen", "Wholesale");
	...
	void readSpecificFacilityType() {
        ...
        facilityTypeDAO.createFacilityType(FACILITY_TYPE);
        Assert.assertEquals(1, facilityTypeDAO.readAllFacilityTypes("BeerGameZutphen").size());
        FacilityTypeDB facilityTypeDb = facilityTypeDAO.readSpecificFacilityType(FACILITY_TYPE.getGameId(), FACILITY_TYPE.getFacilityName());
